...
namespace EventEaseWebApp.Controllers
{
    public class BookingController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingId,EventId,VenueId,BookingDate,IsConfirmed")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookingId,EventId,VenueId,BookingDate,IsConfirmed")] Booking booking)
        {
            if (ModelState.IsValid)
            {
